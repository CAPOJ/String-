...
START_TEST(to_upper_testing) {
  ...
  char result1[] = "TEST";
  char *got1 = s21_to_upper(value1);
  const char value2[] = "TEst test";
  char result2[] = "TEST TEST";
  char *got2 = s21_to_upper(value2);
  const char value3[] = "TEst656test";
  char result3[] = "TEST656TEST";
  char *got3 = s21_to_upper(value3);
  ck_assert_str_eq(result1, got1);
  ck_assert_str_eq(result2, got2);
  ck_assert_str_eq(result3, got3);
  if (got1) free(got1);
  if (got2) free(got2);
  if (got3) free(got3);
}
...
START_TEST(to_lower_testing) {
  const char value1[] = "TEst";
  char result1[] = "test";
  char *got1 = s21_to_lower(value1);
  const char value2[] = "TEst test";
  char result2[] = "test test";
  char *got2 = s21_to_lower(value2);
  const char value3[] = "TEst656test";
  char result3[] = "test656test";
  char *got3 = s21_to_lower(value3);
  ck_assert_str_eq(result1, got1);
  ck_assert_str_eq(result2, got2);
  ck_assert_str_eq(result3, got3);
  if (got1) free(got1);
...
START_TEST(insert_testing) {
  ...
  char *got1 = s21_insert(src, value1, 2);
  char *got2 = s21_insert(src, value1, 1);
  char *got3 = s21_insert(src, value1, 0);
  ck_assert_str_eq(result1, got1);
  ck_assert_str_eq(result2, got2);
  ck_assert_str_eq(result3, got3);
  if (got1) free(got1);
...
START_TEST(trim_testing) {
  const char src1[] = "3/rxtut3/rx";
  const char trim_chars1[] = "3/rx";
  const char src2[] = "hhghghggtuthgh";
  const char trim_chars2[] = "hg";
  const char src3[] = "tutjopa";
  const char trim_chars3[] = "jopa";
  char result[] = "tut";
  char *got1 = s21_trim(src1, trim_chars1);
  char *got2 = s21_trim(src2, trim_chars2);
  char *got3 = s21_trim(src3, trim_chars3);
  ck_assert_str_eq(result, got1);
  ck_assert_str_eq(result, got2);
  ck_assert_str_eq(result, got3);
  if (got1) free(got1);
  if (got2) free(got2);
  if (got3) free(got3);
}
